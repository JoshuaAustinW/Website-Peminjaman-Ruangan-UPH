...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="whitebox">
            ...
            <form id="formRegis" class="LoginRegisForm" method="POST" action="">
                ...
                <input id="username" class="InputText" style="margin-bottom: 5%;" name="username"
                    placeholder="Type your username" type="text" onkeypress="usernameInputFilter(event)" maxlength="50"
                    required onpaste="return false;" autocomplete="off"
                    value="<?php if (isset($_SESSION['regis_username'])) {
                ...
                <input id="email" class="InputText" style="margin-bottom: 5%;" name="email"
                    placeholder="Type your email" type="email" onkeypress="preventSpace(event)" maxlength="50" required
                ...
                <input id="password" class="InputText" style="margin-bottom: 5%;" name="password"
                    placeholder="Type your password" type="password" onkeypress="preventSpace(event)" maxlength="50"
                    required onpaste="return false;"
                    value="<?php if (isset($_SESSION['regis_password'])) {
                        echo $_SESSION['regis_password'];
                ...
                <div class="passwordContainer">
                    <input id="confirmPassword" class="InputText password" style="margin-bottom: 5%;"
                        name="confirmpassword" placeholder="Confirm your password" type="password"
                        onkeypress="preventSpace(event)" maxlength="50" required onpaste="return false;"
                        value="<?php if (isset($_SESSION['regis_confirmpassword'])) {
                            echo $_SESSION['regis_confirmpassword'];
                            unset($_SESSION['regis_confirmpassword']);
                        } else
                            echo ''; ?>">
            ...
            <div class="Signin">Have an account already? <a href="../Login/Login.php" target="_self"
                    class="Remembermetext ForgotPassword">Sign In!</a></div>
    ...
    <div class="BoxOTP hidden" id="BoxOTP">
        ...
        <div class="formOTP" name="formOTP">
            ...
            <input id="OTPInput" name="OTPInput" placeholder="Input your OTP" class="OTPInput" type="text" maxlength="6"
                autocomplete="off">

            <div class="OTPErrorWrapper">
                <div id="OTPError"></div>
            </div>
