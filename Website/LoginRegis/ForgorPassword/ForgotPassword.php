    ...
    <div class="wrapper">
        ...
        <div class="whitebox">
            ...
            <form id="ForgotPasswordForm" class="LoginRegisForm" method="post" action="">
                ...
                <input class="InputText" style="margin-bottom: 5%;" id="email" name="email"
                    placeholder="Type your email" type="email" onkeypress="preventSpace(event)" maxlength="50" required
                    onpaste="return false;"
                    value="<?php if (isset($_SESSION['forgot_email'])) {
                ...
                <input class="InputText" id="InputPassword" style="margin-bottom: 3%;" name="password"
                    placeholder="Type your password" type="password" onkeypress="preventSpace(event)" maxlength="50"
                    required onpaste="return false;"
                    value="<?php if (isset($_SESSION['forgot_password'])) {
                ...
                <div class="passwordContainer">
                    <input class="InputText password" id="InputConfirmPassword" style="margin-bottom: 3%;"
                        name="confirmpassword" placeholder="Type your password" type="password"
                        onkeypress="preventSpace(event)" maxlength="50" required onpaste="return false;"
                        value="<?php if (isset($_SESSION['forgot_confirmpassword'])) {
                            echo $_SESSION['forgot_confirmpassword'];
                            unset($_SESSION['forgot_confirmpassword']);
                        } else
                            echo ''; ?>">
            ...
            <div class="Signup">Don’t have an account? <a href="../Register/Register.php" target="_self"
                    class="Remembermetext ForgotPassword">Sign Up!</a></div>
